/*
 * Archivo: T_CNTASHLWLUDIX_727.java
 * Fecha: 2020-12-29T23:08:26Z
 *
 ...
 * T_CNTASHLWLUDIX_727 - CreateAccount 
 *
 */
@Path("/CNTAS/ADMIN/T_CNTASHLWLUDIX_727")
@Component
@Service({T_CNTASHLWLUDIX_727.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CNTAS)(task.submodule=ADMIN)(task.id=T_CNTASHLWLUDIX_727)(task.version=1.0.0))")
,@Reference(name="VW_CREATEACTO_419", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CREATEACTO_419)(view.version=1.0.0))")
...
public class T_CNTASHLWLUDIX_727 {
