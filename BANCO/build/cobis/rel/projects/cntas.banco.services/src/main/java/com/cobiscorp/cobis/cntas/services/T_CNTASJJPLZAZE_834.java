/*
 * Archivo: T_CNTASJJPLZAZE_834.java
 * Fecha: 2020-12-28T16:55:11Z
 *
 ...
 * T_CNTASJJPLZAZE_834 - FormCliente 
 *
 */
@Path("/CNTAS/ADMIN/T_CNTASJJPLZAZE_834")
@Component
@Service({T_CNTASJJPLZAZE_834.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CNTAS)(task.submodule=ADMIN)(task.id=T_CNTASJJPLZAZE_834)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTEGQT_977", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CLIENTEGQT_977)(view.version=1.0.0))")
,@Reference (name="QV_YJ32_MTA13",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_YJ32_MTA13)")
,@Reference(name="Q_CLIENETT_YU32",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CLIENETT_YU32)(query.version=1.0.0))")
...
public class T_CNTASJJPLZAZE_834 {
